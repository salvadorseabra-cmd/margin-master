...
export const OPERATIONAL_FAMILY_REGISTRY: Record<OperationalFamilyId, OperationalFamilyDefinition> =
  {
    burger_bread: {
      id: "burger_bread",
      phrases: [
...
export function operationalFamiliesIncompatibleFromRaw(rawA: string, rawB: string): boolean {
